...
//   it("should loop around until the final page is found", async () => {
//    await stateDrivenUtils.partyPath("host zombieton"); // Host path through the party
//   });
// });
...
//    await stateDrivenUtils.partyPath("skip"); // Skip path through the party
//   });
// });

// describe("Ch14: State-drive Automation - Attend a Party in Zombieton", () => {
//   it("should loop around until the final page is found", async () => {
//   await  stateDrivenUtils.partyPath("attend zombieton"); // Attend path through the party
//   });
//});
